...
public class ExpandableSocialTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public ExpandableSocialTextView(Context context) {
        this(context, null);
    }

    public ExpandableSocialTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
